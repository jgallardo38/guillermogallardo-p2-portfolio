...
This boxplot shows the distribution across three different ethinicities, labeled as B for Black/African American, H for Hispanic, and W for White. There are not outliers, but that B has the lowest median height while H has the highest median height. W has the largest variability between these three groups which tells us that thhis groups has members that have many different heights. 
...
The data points from this scatter plot are spread across the plot and it is not showing a strong linear pattern, This suggest that there may bit be a strong relationship between this two variables.
